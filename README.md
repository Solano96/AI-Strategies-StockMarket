...
* [Deep Neural Network](https://github.com/Solano96/AI-Strategies-StockMarket/blob/master/docs/neural_network.md): strategy that tries to predict the market trend with the use of neural networks that take different technical indicators as inputs.
